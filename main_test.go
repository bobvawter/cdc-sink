...
func TestTypes(t *testing.T) {
	...
	testcases := []struct {
		...
		// TODO(bob): Determine how to get the server to accept its own output.
...
// loopUntilMaxB waits for the maximum value of the "B" value in
// tableTo to become equal to that of tableFrom or for the Context
// to be cancelled.
func loopUntilMaxB(
	ctx context.Context,
...
// loopUntilSync waits for the number of rows in tableTo to become
// equal to the number of rows in tableFrom or for the Context to
// be cancelled.
func loopUntilSync(
	ctx context.Context,
	tableTo, tableFrom interface {
